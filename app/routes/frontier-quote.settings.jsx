 ...
 * This endpoint is called from frontier-quote.js on the storefront via app proxy
 *
 * GET /apps/frontier-quote/settings?country_code=XX
 *
...
export const loader = async ({ request }) => {
  try {
    ...
    console.error("Error in frontier-quote settings endpoint:", error);
