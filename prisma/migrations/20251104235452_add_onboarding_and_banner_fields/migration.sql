...
INSERT INTO "new_Settings" ("blacklistCountries", "createdAt", "draftOrderTags", "id", "popupFields", "regionMode", "regions", "shopId", "updatedAt", "whitelistCountries") SELECT "blacklistCountries", "createdAt", "draftOrderTags", "id", "popupFields", "regionMode", "regions", "shopId", "updatedAt", "whitelistCountries" FROM "Settings";
DROP TABLE "Settings";
